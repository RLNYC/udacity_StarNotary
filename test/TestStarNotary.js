...
it('can add the star name and star symbol properly', async() => {
    ...
    let tokenId = 6;
    let name = "UdacitySolProject";
    let symbol = "USP";
    let instance = await StarNotary.deployed();
    await instance.createStar('Cool Star!', tokenId, {from: accounts[0]});
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 7;
    let starId2 = 8;
    await instance.createStar('YO star', starId1, {from: user1});
    await instance.createStar('HI star', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[2];
    let starId = 9;
    await instance.createStar('HEY star', starId, {from: user1});
